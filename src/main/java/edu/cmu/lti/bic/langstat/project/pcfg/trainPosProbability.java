...
public class trainPosProbability {
	...
	TreeMap<String, HashMap<String, Double>> finish() {
		Iterator<Entry<String, HashMap<String, Double>>> it = PosPool
				.entrySet().iterator();
		while (it.hasNext()) {
			Entry<String, HashMap<String, Double>> pairs = (Entry<String, HashMap<String, Double>>) it
					.next();
			HashMap<String, Double> map = (HashMap<String, Double>) pairs
					.getValue();
			double count = 0;
	...
	HashMap<String, Double> createPosMap() {
		...
		String[] array = { "CC", "CD", "DT", "EX", "FW", "IN", "JJ", "JJR",
